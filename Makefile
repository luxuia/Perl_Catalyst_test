...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/lolcatalyst_lite_cgi.pl \
...
PM_TO_BLIB = lib/LolCatalyst/Lite/Controller/Root.pm \
...
pure_all :: $(INST_SCRIPT)/lolcatalyst_lite_server.pl $(INST_SCRIPT)/lolcatalyst_lite_create.pl $(INST_SCRIPT)/lolcatalyst_lite_test.pl $(INST_SCRIPT)/lolcatalyst_lite_fastcgi.pl $(INST_SCRIPT)/lolcatalyst_lite_cgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/lolcatalyst_lite_server.pl $(INST_SCRIPT)/lolcatalyst_lite_create.pl \
	  $(INST_SCRIPT)/lolcatalyst_lite_test.pl $(INST_SCRIPT)/lolcatalyst_lite_fastcgi.pl \
	  $(INST_SCRIPT)/lolcatalyst_lite_cgi.pl 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>luxuia,,,</AUTHOR>' >> $(DISTNAME).ppd
